...
def filepath_to_module_path(filepath: Path) -> str:
...
def list_fixture_modules() -> list[str]:
    ...
    Example:
    - relative filepath: `tests/fixtures/test_data.py`
    - module path: `tests.fixtures.test_data`
    """
    ...
    return [
        filepath_to_module_path(fixture_filepath.relative_to(root_path))
